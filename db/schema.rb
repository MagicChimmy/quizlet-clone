...
ActiveRecord::Schema.define(version: 2019_06_17_195446) do
  ...
  create_table "folder_lists", force: :cascade do |t|
    ...
    t.index ["folder_id"], name: "index_folder_lists_on_folder_id"
    t.index ["list_id"], name: "index_folder_lists_on_list_id"
  end
